  ...
  return (
    <div className="min-h-screen bg-zinc-950 text-zinc-100 flex flex-col justify-between selection:bg-emerald-500/30 selection:text-emerald-300">
      <Head>
        ...
        <link rel="canonical" href="https://echoreader.ai.stream-in.app" />

        {/* OpenGraph / Facebook */}
        <meta property="og:type" content="website" />
        <meta property="og:url" content="https://echoreader.ai.stream-in.app" />
        ...
        <meta property="og:image" content="https://echoreader.ai.stream-in.app/assets/seo-banner.jpg" />

        {/* Twitter */}
        <meta property="twitter:card" content="summary_large_image" />
        <meta property="twitter:url" content="https://echoreader.ai.stream-in.app" />
        ...
        <meta property="twitter:image" content="https://echoreader.ai.stream-in.app/assets/seo-banner.jpg" />
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              "@type": "WebApplication",
              "name": "EchoReader AI",
              "url": "https://echoreader.ai.stream-in.app",
